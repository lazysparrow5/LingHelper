...
// LingHelperDoc.cpp: CLingHelperDoc 类的实现
//
...
IMPLEMENT_DYNCREATE(CLingHelperDoc, CDocument)
...
BOOL CLingHelperDoc::OnNewDocument()
{
...
// 搜索处理程序的支持
void CLingHelperDoc::InitializeSearchContent()
{
...
#ifdef _DEBUG
void CLingHelperDoc::AssertValid() const
{
